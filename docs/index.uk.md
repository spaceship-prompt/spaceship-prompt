...
- Статуси репозиторіїв (підтримуються Git та Mercurial)
- Оточення для різних мов (Node.js, Rust, Python, Ruby, Swift, Go, PHP та багато інших)
- Версію Docker, контекст Kubernetes і під'єднана машину
- Версію пакунку (npm, lerna, cargo, composer та інші)
- Поточний рівень заряду батареї та її статус
- Індикатор для задач, що виконуються у фоновому режимі `✦`
- Багато іншої [корисної інформації](/sections)
- Додаткову [інформацію на ваш вибір](/advanced/creating-section)
