...
| `SPACESHIP_DIR_TRUNC_PREFIX` |                 -                  | Prefix before cwd when it's truncated. For example `…/` or `.../`, empty to disable For example `…/` or `.../`, empty to disable For example `…/` or `.../`, empty to disable |
