...
You can add more line breaks to the prompt by adding more `line_sep` sections where you want. You can use `spaceship add` command for that: You can use `spaceship add` command for that: You can use `spaceship add` command for that:
