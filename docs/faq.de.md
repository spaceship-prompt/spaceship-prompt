...
Diese Seite soll Ihnen helfen, häufig auftretende Probleme mit Spaceship zu lösen.

Wenn du Probleme mit etwas hast, kannst du gerne eine Frage auf unserem Discord Server oder im GitHub-Diskussionsforum stellen:

[:fontawesome-brands-discord: Discord][discord]{ .md-button }
[:fontawesome-brands-github: Discussions][discussions]{ .md-button }

## Warum sieht meine Eingabeaufforderung nicht so aus wie die Vorschau?
...
Die Vorschau zeigt die `spaceship` prompt mit folgender Konfiguration:

- **Konsole**
    - [iTerm2](https://iterm2.com/) als Terminal-Emulator.
    - [One Dark](https://www.npmjs.com/package/hyperterm-atom-dark) als Farbschema.
    - [FiraCode Nerd Font](https://www.nerdfonts.com/font-downloads) mit Ligaturen als primäre Schriftart (Größe 16px).
- **Shell-Konfiguration**
    - [denysdovhan's Dotfiles](https://github.com/denysdovhan/dotfiles)
    - [zsh-syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) um Befehle einfärben zu lassen.
    - [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) für Browser-ähnliche Autovervollständigung.

Siehe das [screenshots](https://github.com/spaceship-prompt/spaceship-prompt/wiki/Screenshots) Wiki für weitere Farbschema-Beispiele.

## Wie bekomme ich die Vervollständigung der Befehle wie in der Demo GIF?

Verwende [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) um Browser-ähnliche Befehlsvervollständigungen basierend auf dem Verlauf und Vervollständigung zu erhalten.
