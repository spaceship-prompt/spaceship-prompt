...
Note: For oh-my-zsh users with vi-mode plugin enabled: Add `export RPROMPT=` to your configuration to disable default `<<<` NORMAL mode indicator in right prompt.
