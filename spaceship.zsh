...
# PROMPT
# TODO: Document SEPARATOR, PREFIXES, SUFFIXES, DEFAULT_PREFIX
...
SPACESHIP_PROMPT_TRUNC="${SPACESHIP_PROMPT_TRUNC:=3}" # TODO: Move to DIR
...
SPACESHIP_DOCKER_SUFFIX="${SPACESHIP_DOCKER_SUFFIX:="on "}"
