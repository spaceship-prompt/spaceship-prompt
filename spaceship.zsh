...
export SPACESHIP_VERSION='3.0.1'
...
if [ -z "$SPACESHIP_PROMPT_ORDER" ]; then
  if [ -z "$SPACESHIP_PROMPT_ORDER_LINE_1" ]; then
    SPACESHIP_PROMPT_ORDER_LINE_1=(
  ...
  if [ -z "$SPACESHIP_PROMPT_ORDER_LINE_2" ]; then
    SPACESHIP_PROMPT_ORDER_LINE_2=(
