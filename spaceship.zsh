...
export SPACESHIP_VERSION='4.14.1'
...
SPACESHIP_PROMPT_COLORFUL_PREFIXES="${SPACESHIP_PROMPT_COLORFUL_PREFIXES=false}"
SPACESHIP_PROMPT_SUFFIXES_SHOW="${SPACESHIP_PROMPT_SUFFIXES_SHOW=true}"
SPACESHIP_PROMPT_COLORFUL_SUFFIXES="${SPACESHIP_PROMPT_COLORFUL_SUFFIXES=false}"
